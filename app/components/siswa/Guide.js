...
export default class Guide extends Component {
    ...
    render() {
        var missionList = this.props.mission.map((misi,index) => {
            ...
            return <li key={index} className={missionClass}>{misi.soal}</li>;
        })

        return (
            <div id="guide" className="col-sm" style={{ marginLeft: "10px",marginTop: "10px"}}>
                <div className="row">
                ...
                <div className="row" style={{marginTop:"10px"}}>
                    <div className="card col-sm-12">
                        <button type="button"   onClick={this.showTeory} className="btn btn-primary">Materi</button>
                    </div>
                </div>
                <div className="row" style={{ marginTop: "10px" }}>
                ...
                <Modal visible={this.state.showModal} onClickBackdrop={this.modalClosed}>
                    <div className="modal-header">
                        <h5 className="modal-title">{ this.props.judul } ({this.state.runtime})</h5>
                    </div>
                    <div className="modal-body">
                        <div className="card-body" dangerouslySetInnerHTML={{__html:  this.props.materi}}></div>
                    </div>
